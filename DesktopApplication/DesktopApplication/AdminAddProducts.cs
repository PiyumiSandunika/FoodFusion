...
namespace DesktopApplication
{
    public partial class AdminAddProducts : UserControl
    {
                    ...
                    try
                    {
                        ...
                        using (SqlCommand selectPID = new SqlCommand(selectProdID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\User\Desktop\GUI PROJECT\FoodFusion\DesktopApplication\DesktopApplication\Product_Directory\"
        ...
        private void adminAddProducts_updateBtn_Click(object sender, EventArgs e)
        {
            if (emptyFields())
            {
                MessageBox.Show("All field are requried to be filled", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error );
            }
            else
            {
